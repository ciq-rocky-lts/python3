...
Patch438: 5000-add-to-supported-dists.patch
...
%changelog
* Fri Oct 25 2024 Jonathan Dieter <jdieter@ciq.com> - 3.7.8-67.rocky.0.el8_6
- Sync from Rocky upstream
- Undo -O3 build since this is an LTS release
- Undo explicit RPM Provides since this is an LTS release

* Tue Sep 24 2024 Release Engineering <releng@rockylinux.org> - 3.6.8-67.rocky.0
